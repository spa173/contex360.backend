...
*   **Reglas Backend, NestJS, Prisma y Rendimiento:** Lee y aplica obligatoriamente [.claude/backend-rules.md](file:///c:/Users/camilo/Desktop/contex360.backend/.claude/backend-rules.md) y [.claude/backend-product-rules.md](file:///c:/Users/camilo/Desktop/contex360.backend/.claude/backend-product-rules.md) (para lógica del catálogo y productos).
*   **Reglas de Facturación Electrónica DIAN:** Lee y aplica obligatoriamente [.claude/backend-dian-rules.md](file:///c:/Users/camilo/Desktop/contex360.backend/.claude/backend-dian-rules.md).
